  ...
  return (
    <section className={styles.wrok} id='work'>
      ...
      <div className={styles.wrokimgs}>
        <img src="/my-Potfolio/assets/portfolio-1.png" alt="Image" />
        <img src="/my-Potfolio/assets/portfolio-2.png" alt="Image" />
        <img src="/my-Potfolio/assets/portfolio-3.png" alt="Image" />
        <img src="/my-Potfolio/assets/portfolio-4.png" alt="Image" />
        <img src="/my-Potfolio/assets/portfolio-5.png" alt="Image" />
        <img src="/my-Potfolio/assets/portfolio-6.png" alt="Image" />
      </div>
    </section>
  )
}
