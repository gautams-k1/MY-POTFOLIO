        ...
        <div className={styles.MyWorkContact}>
            <div className={styles.MyWorkContact_items}>
                <div className={styles.outer}>
                    <img src="/assets/port_item-1.jpg" alt="" />
                </div>
            ...
            <div className={styles.MyWorkContact_items}>
                <div className={styles.outer}>
                    <img src="/assets/port_item-2.jpg" alt="" />
                </div>
                <div className={styles.inner}>
                  <div className={styles.port_btn}>
                    <a className={styles.port_search} href="#/"></a>
            ...
            <div className={styles.MyWorkContact_items}>
                <div className={styles.outer}>
                    <img src="/assets/port_item-3.jpg" alt="" />
                </div>
                <div className={styles.inner}>
                  <div className={styles.port_btn}>
                    <a className={styles.port_search} href="#/"></a>
            ...
            <div className={styles.MyWorkContact_items}>
                <div className={styles.outer}>
                    <img src="/assets/port_item-4.jpg" alt="" />
                </div>
                <div className={styles.inner}>
                  <div className={styles.port_btn}>
                    <a className={styles.port_search} href="#/"></a>
            ...
            <div className={styles.MyWorkContact_items}>
                <div className={styles.outer}>
                    <img src="/assets/port_item-5.jpg" alt="" />
                </div>
                <div className={styles.inner}>
                  <div className={styles.port_btn}>
                    <a className={styles.port_search} href="#/"></a>
            ...
            <div className={styles.MyWorkContact_items}>
                <div className={styles.outer}>
                    <img src="/assets/port_item-6.jpg" alt="" />
                </div>
                <div className={styles.inner}>
                  <div className={styles.port_btn}>
                    <a className={styles.port_search} href="#/"></a>
